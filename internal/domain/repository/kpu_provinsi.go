...
type KPUProvinsiRepository interface {
	InsertKPUProvinsi(ctx context.Context, kpu *model.KPUProvinsi, signedTransaction string) (string, error)
	...
	UpdateKPUProvinsi(ctx context.Context, kpu *model.KPUProvinsi, signedTransaction string) (string, error)
}
